...
import { FileManager, ImageInformation } from "./engine/FileManager";
...
async function getImagesInDirectory(event: Electron.IpcMainInvokeEvent, directory: string): Promise<ImageInformation[]> {
